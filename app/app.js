...
(function () {
  ...
  function renderDashboard() {
    ...
    return (
      ...
      '<h1 class="kn-heading-1 kn-mb-3">Dashboard</h1>' +
      banner +
      filterBarHtml() +
  ...
  function renderProof() {
    return (
      '<div class="app-proof">' +
      '<h1 class="kn-heading-1 kn-mb-2">Proof</h1>' +
      '<p class="app-page__subtext kn-mb-4">Placeholder for artifact collection. This section will be built in the next step.</p>' +
      '<div class="kn-card">' +
      '<p class="kn-card__body" style="margin:0;">Artifact collection area.</p>' +
      '</div>' +
      '</div>'
    );
  }
